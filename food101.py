...
print("Loading metadata...") #Загружаем список классов(идёт вместе с датасетом)
class_to_ix = {}
ix_to_class = {}
...
# Раскидываем датасет на папки для обучения, проверки и теста
...
print("First pass")
checkpointer = ModelCheckpoint(filepath='weightsfirst.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=True)
...
checkpointer = ModelCheckpoint(filepath='weightssecond.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=True)
